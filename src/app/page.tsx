    ...
    <main>
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden -z-10">
          <div className="absolute top-1/4 -left-10 w-72 h-72 bg-purple-500/30 rounded-full filter blur-3xl animate-float"></div>
          <div className="absolute bottom-1/4 -right-10 w-72 h-72 bg-sky-500/20 rounded-full filter blur-3xl animate-float delay-200"></div>
          <div className="absolute top-2/3 left-1/3 w-60 h-60 bg-pink-500/20 rounded-full filter blur-3xl animate-float delay-300"></div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeIn">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
                ...
                <br />
                <span className="text-4xl md:text-5xl">Send SOL with Heart</span>
              </h1>
              ...
              <div className="aspect-square max-w-md mx-auto relative">
                ...
                <div className="relative p-6 h-full flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col justify-center items-center text-center">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg mb-4 text-center w-full">
      ...
      <section className="section">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative animate-scaleIn">
              <div className="aspect-video max-w-lg relative mx-auto">
                ...
                <div className="absolute inset-0 bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden">
                  <div className="relative h-full flex items-center justify-center">
                    <div className="w-full max-w-sm mx-auto grid grid-cols-2 gap-4 p-6">
                      <div className="col-span-2 card bg-gray-50 dark:bg-gray-700/50 p-4 text-center">
                        <div className="gradient-text text-xl font-bold">1.75 SOL</div>
                        <div className="text-sm text-gray-500">Total Received</div>
                      </div>
                      <div className="card bg-gray-50 dark:bg-gray-700/50 p-4 text-center">
            ...
            <div className="animate-fadeIn">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Track Your Regards</h2>
      ...
      <section className="section relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200%] aspect-square bg-gradient-to-br from-purple-600/20 via-blue-500/20 to-pink-500/20 rounded-full animate-pulse"></div>
        </div>
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Join DropRegards Today</h2>
      ...
      <footer className="py-12 border-t border-gray-200 dark:border-gray-800">
        <div className="container">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500 dark:text-gray-400">
            <p>© {new Date().getFullYear()} DropRegards. All rights reserved.</p>
